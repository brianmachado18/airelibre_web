...
<<<<<<< Updated upstream
 * 2024-10-23T22:20:02.577-03:00
=======
 * 2024-11-01T13:20:23.513-03:00
>>>>>>> Stashed changes
 * Generated source version: 4.0.5
 *
 */
@WebServiceClient(name = "PublicadorService",
                  wsdlLocation = "http://localhost:9139/publicador?wsdl",
                  targetNamespace = "http://servidor/")
public class PublicadorService extends Service {

    public static final URL WSDL_LOCATION;

    public static final QName SERVICE = new QName("http://servidor/", "PublicadorService");
    public static final QName PublicadorPort = new QName("http://servidor/", "PublicadorPort");
    static {
        URL url = null;
        try {
            url = URI.create("http://localhost:9139/publicador?wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PublicadorService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:9139/publicador?wsdl");
        }
        WSDL_LOCATION = url;
    }
