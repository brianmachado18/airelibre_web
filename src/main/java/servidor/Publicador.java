...
public interface Publicador {
    ...
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<net.java.dev.jaxb.array.StringArray> obtenerArrayActividadesEntrenador(
 ...
 throws PersistenciaException_Exception;
    ...
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<java.util.ArrayList> obtenerArrayActividadesAceptadasEntrenador(
