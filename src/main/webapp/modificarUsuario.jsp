		...
		<div class="flex-1 p-5 flex items-start" style="margin-left: 25rem;">
			...
			<div class="bg-white rounded-lg shadow-md p-6 max-w-lg w-full"
  			...
  			<form id="modificarForm" action="modificarUsuario" method="POST" >
                ...
                <div class="mb-4">
                    <label for="correo" class="block text-gray-700">Correo Electr�nico:</label>
                ...
                <div class="mb-4">
                    <label for="confirmarContrasena" class="block text-gray-700">Confirmar Contrase�a:</label>
    ...
    <script>
        ...
        document.getElementById('userForm').onsubmit = function(event) {
            ...
            if (imagePath && !allowedExtensions.exec(imagePath)) {
                alert('Por favor sube un archivo de imagen v�lido (JPG, JPEG o PNG).');
                event.preventDefault();
                imageInput.value = '';
            }
        };
