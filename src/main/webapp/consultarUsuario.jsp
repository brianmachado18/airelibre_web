...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-5 flex items-start" style="margin-left: 25rem;"> <!-- Estilo inline para margen -->
            ...
            <div class="bg-white rounded-lg shadow-md p-6 max-w-lg w-full" style="margin-right: 2rem;">
                ...
                <form id="userForm" action="altaUsuario" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="apellido" name="apellido" class="border border-gray-300 rounded w-full p-2" disabled>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" id="contrasena" name="contrasena" class="border border-gray-300 rounded w-full p-2" disabled>
                    </div>

                    <div class="mb-4">
                        <label for="confirmar" class="block text-gray-700">Confirmar Contraseña:</label>
                        <input type="password" id="confirmar" name="confirmar" class="border border-gray-300 rounded w-full p-2" disabled>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md w-48 h-48 flex items-center justify-center"> <!-- Sin margen izquierdo -->
